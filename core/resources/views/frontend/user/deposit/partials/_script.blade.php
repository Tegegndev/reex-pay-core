                ...
                if (isMobileMoney) {
                    $('#mobile-money-credentials').html(`
                        <div class="single-input-inner style-border mt-3">
                            <label class="form-label">{{ __('Mobile Money Phone Number (MTN / Airtel)') }}</label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="phone_number" id="phone_number"
                                       value="${userPhone}"
                                       placeholder="{{ __('Enter MTN or Airtel Number (e.g. 074... or 077...)') }}" required>
                                <span class="input-group-text"><i class="fas fa-mobile-alt"></i></span>
                            </div>
                            <span class="small color-base fw-500 text-muted mt-1 d-block">
                                <i class="fas fa-info-circle me-1"></i>{{ __('Enter any MTN or Airtel phone number to receive the USSD PIN prompt.') }}
                            </span>
                        </div>
                    `);
                }
